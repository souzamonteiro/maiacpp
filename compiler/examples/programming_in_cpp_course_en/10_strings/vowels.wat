...
(module
  ...
  (elem (table $fn_table) (i32.const 0) func $__cpp_tolower $count_vowels__pv $main $count_vowels__c)
  ...
  ;; function count_vowels__c
  (func $count_vowels__c (param $name i32) (result i32)
    (local $__frame i32)
    (local $i i32)
    (local $n i32)
    (local $__tmp_i32 i32)
    ...
    local.get $__tmp_i32
    drop
    block $count_vowels__c_for_exit_0
      loop $count_vowels__c_for_loop_2
        local.get $__frame
        i32.const 4
        i32.add
        i32.load
        ...
        i32.eqz
        i32.eqz
        br_if $count_vowels__c_for_exit_0
        block $count_vowels__c_for_continue_1
          local.get $__frame
          i32.const 0
          i32.add
          i32.load8_u
  ...
  (export "count_vowels__c" (func $count_vowels__c))
